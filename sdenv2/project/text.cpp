...
Text::Text(const char* font, float _scale, glm::vec3 _color){
	this->setFont(font);
	this->scale = _scale;
	this->color = _color;
...
void Text::setColorLerp(glm::vec3 s, glm::vec3 e){
	_lerpColors.clear();
...
void Text::removeColorLerp(){
	_lerpColors.clear();
}

bool Text::doColorLerp(){
...
glm::vec3 Text::getColorLerp(int i){
